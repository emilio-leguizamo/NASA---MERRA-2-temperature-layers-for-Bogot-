...
write.csv(final_df,"C:\\Users\\EMILIOLE\\OneDrive - Inter-American Development Bank Group\\Documents\\Data\\Colombia\\NASA\\air_temp_bog_2015_2023.csv")
...
for (y in c("TLML", "SPEEDLML", "QLML", "PS", "HLML")) {
  ...
  for (x in 1:n) { 
    ...
    #Surface temperature
      #tmp_array <- ncvar_get(nc_data,"TLML")
      #dim(tmp_array)
...
write.csv(final_df_st,"C:\\Users\\EMILIOLE\\OneDrive - Inter-American Development Bank Group\\Documents\\Data\\Colombia\\NASA\\surface_vars_bog_2015_2023.csv")
